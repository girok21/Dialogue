...
const Actions = ({ liked, setLiked }) => {
  return (
    <Flex gap={3} my={2} onClick={(e) => e.preventDefault()} cursor={"pointer"}>
        <svg aria-label="Like" color={liked? "rgb(237, 73, 86)": "currentColor"} fill={liked? "rgb(237, 73, 86)": "transparent"} height="19" role="img" viewBox="0 0 24 22" width="20" onClick={()=>{setLiked(!liked)}}>
