  ...
  return (
    <>
        ...
        >
            ...
            >
              <HomeSvg outlineColor={outlineColor} fillColor={fillColor} isFilled={pathObject['/home']}/>
            </Box>
            <Box
              className="navbar_icon"
              _hover={{
            ...
            >
              <SearchSvg outlineColor={outlineColor} fillColor={fillColor} isFilled={pathObject['/search']}/>
            </Box>
            <Box
              className="navbar_icon"
              _hover={{
            ...
            >
              <HeartSvg outlineColor={outlineColor} fillColor={fillColor} isFilled={pathObject['/activity']}/>
            </Box>
            <Box
              className="navbar_icon"
              _hover={{
...
const HeartSvg = ({outlineColor, fillColor, isFilled})=>{
  return(
    <svg aria-label="Notifications" fill={isFilled? fillColor : "transparent"} height="26" role="img" viewBox="0 0 26 26" width="26"><title>Notifications</title><path d="M2.5 9.85683C2.5 14.224 6.22178 18.5299 12.0332 22.2032C12.3554 22.397 12.7401 22.5909 13 22.5909C13.2703 22.5909 13.655 22.397 13.9668 22.2032C19.7782 18.5299 23.5 14.224 23.5 9.85683C23.5 6.11212 20.8698 3.5 17.4599 3.5C15.4847 3.5 13.9356 4.39792 13 5.74479C12.0851 4.40812 10.5257 3.5 8.5401 3.5C5.14059 3.5 2.5 6.11212 2.5 9.85683Z" stroke={isFilled? fillColor :outlineColor} strokeWidth="2.5"></path></svg>)
}

const ProfileSvg = ({outlineColor, fillColor, isFilled})=>(
  <svg aria-label="Profile" fill={isFilled? fillColor : "transparent"} height="26" role="img" viewBox="0 0 26 26" width="26"><title>Profile</title><circle cx="13" cy="7.25" r="4" stroke={isFilled? fillColor :outlineColor} strokeWidth="2.5"></circle><path d="M6.26678 23.75H19.744C21.603 23.75 22.5 23.2186 22.5 22.0673C22.5 19.3712 18.8038 15.75 13 15.75C7.19625 15.75 3.5 19.3712 3.5 22.0673C3.5 23.2186 4.39704 23.75 6.26678 23.75Z" stroke={isFilled? fillColor :outlineColor} strokeWidth="2.5"></path></svg>
)